...
// 这就是插件
// vue2.0 插件写法要素：导出一个对象，由install函数，默认传入了vue构造函数，vue基础之上扩展
// vue3.0 插件写法要素：导出一个对象，由install函数，默认传入了App应用实例，app基础之上扩展
...
const defineDirective = (app) => {
  // 1. 图片懒加载指令 v-lazy
  // 原理：先存储图片地址不能在src上，当图片进入可视区，将你存储图片地址设置给图片元素即可（这个叫操作DOM）。
  app.directive('lazy', {

  ...
  <div class="goods-comment" v-if="commentInfo">
    ...
    <div class="list" v-if="commentList">
      <div class="item" v-for="item in commentList" :key="item.id">
        ...
        <div class="body">
          <div class="score">
            <i v-for="i in item.score" :key="i + 's'" class="iconfont icon-good-fill"></i>
            <i v-for="i in 5-item.score" :key="i + 'k'" class="iconfont icon-good"></i>
          ...
          <div class="time">
            ...
            <span class="zan"><i class="iconfont icon-good  "></i>{{item.praiseCount}}</span>
          </div>
        </div>
      </div>
    </div>
